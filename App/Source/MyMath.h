...
/*!
\brief
Return a either positive or negative
...
\param min - minimum/maximum range
\param max - minimum/maximum range

\exception None
\return Random float
*/
	inline float SmartRandFloatMinMax(float value1, float value2)
	{
		float num = 0;
		if (value1 > value2)
		{
			num = (value1 - value2) * RandFloat();
			return (num + value2);
		}
		else
		{
			num = (value2 - value1) * RandFloat();
			return (num + value1);
		}
	}//end of SmartRandFloatMinMax function
