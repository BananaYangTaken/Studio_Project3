...
bool CPlayer2D::Init(void)
{
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/Skeleton_SpriteSheet2.png", true);
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/Skeleton_SpriteSheet.png" << endl;
		return false;
	}
	...
	//CS:Play idle animation as default 
	Direction = 0; // animatedSprites->PlayAnimation("idledown", -1, 0.5f);
	...
	//Item intialise
	{
		...
		// Add a Other Tree as one of the inventory items
		cInventoryItem = cInventoryManager->Add("SpruceTree", "Image/SpruceTree.tga", 5, 0);
		cInventoryItem->vec2Size = glm::vec2(25, 25);
...
void CPlayer2D::InteractWithMap(void)
{
	...
	{
	case 2:
		//Erase tree from this position
		cMap2D->SetMapInfo(vec2Index.y, vec2Index.x, 0);
		cInventoryItem = cInventoryManager->GetItem("SpruceTree");
	...
	case 21:
		...
		break;
	case 22:
		//Erase Health from this position
		cMap2D->SetMapInfo(vec2Index.y, vec2Index.x, 0);
